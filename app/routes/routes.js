...
//GET user home page.
router.get('/booksinspace', shelves_controller.shelves_findAll_get);

//Add a book - POST Request
router.post('/booksinspace/books/create', books_controller.books_create_post);

//Mark as Read/Want to Read on update
router.patch('/booksinspace/books/update', books_controller.books_update_patch);

//Rate a book - Post
router.post('/booksinspace/books/create', books_controller.rate_create_post);
